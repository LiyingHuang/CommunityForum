...
public class CommentController implements CommunityConstant {
    ...
    public String addComment(@PathVariable("discussPostId") int discussPostId, Comment comment){
        ...
        // Trigger the comment(Topic) event to send the notification
        // "who"(UserId) likes "the specific comment"(EntityType/EntityUserId) of "the post" (discussPostId)
        ...
        // current thread will send the event to the queue
        // then the messageQueue will handle the next part
